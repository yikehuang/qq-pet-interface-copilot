...
SETTING_FIELDS = [
    ...
    ("adventure.prerequisite_enabled", "学习/打工达标后才允许冒险", bool),
    ("adventure.school_minutes_required", "冒险前累计学习分钟数", int),
    ("adventure.work_minutes_required", "冒险前累计打工分钟数", int),
    ("adventure.start_time", "兼容模式冒险开始时间 HH:MM", str),
